...
gCamAng = 0.
gCamHeight = 1.
glLightColor = (1.,1.,1.,1.)
glObjectColor = (1.,1.,1.,1.)
...
def render():
    global gCamAng, gCamHeight, glLightColor, glObjectColor
...
def key_callback(window, key, scancode, action, mods):
    ...
    if action==glfw.PRESS or action==glfw.REPEAT:
        if key==glfw.KEY_1:
            ...
            glLightColor = (1.,0.,0.,1.)
        elif key ==glfw.KEY_S:
            glLightColor = (0.,1.,0.,1.)
        elif key ==glfw.KEY_D:
            glLightColor = (0.,0.,1.,1.)
        elif key ==glfw.KEY_F:
            glLightColor = (1.,1.,1.,1.)
        elif key ==glfw.KEY_Z:
            glObjectColor = (1.,0.,0.,1.)
        elif key ==glfw.KEY_X:
            glObjectColor = (0.,1.,0.,1.)
        elif key ==glfw.KEY_C:
            glObjectColor = (0.,0.,1.,1.)
        elif key ==glfw.KEY_V:
            glObjectColor = (1.,1.,1.,1.)
